            ...
            >
                <Row css={{ paddingLeft: "5%" }}>
                    ...
                    <Col css={{ justifyContent: "center" }}>
                        <Text size={'1.5rem'} weight="bold"> My Name</Text>
                        <Row align="center">
                            <div
                                style={{
                    ...
                    <Button auto style={{ backgroundColor: "rgba(97, 94, 240, 0.1)" }}>
                        <BsFillTelephoneFill color="#615EF0" />
                        <Spacer x={1} />
                        <Text h3 color="#615EF0">
                            Call
                        </Text>
                    </Button>
                    <Spacer x={2} />
                ...
                >
                    ...
                    <Input
                        width="100%"
                        contentRight={<IoIosSend size={50} color="615EF0" />}
                    />
                </Row>
            </Col>
        </Grid.Container>
